...
;;;;;;;;;;;;;;;; the interpreter ;;;;;;;;;;;;;;;;
  ...
  ;; this is value-of-old is created by ikbal in order to keep track of the environment tables.
  
  (define value-of
    (lambda (exp env)
      (add-to-expstack exp)
      (add-to-envstack env)
      (add-to-stostack (get-store-as-list))
  ...
  (define value-of-old
    (lambda (exp env)
	  ...
	  (if (instrument-let)
	    (eopl:printf "entering let ~s~%" var)(eopl:printf ""))
